var marker; //마커를 전역변수로 선언
                                 ...
                                 '<button id="closeButton" class="co-close"></button>'+
                                     '<div class="co-title">'+
                                         ...
                                         if(places.category_group_code === 'CE7'){
                                            overlayContent += '<span id="placeCode" class="badge bg-warning mx-2">카페</span></div>';
                                         ...
                                         '</div>'+
                                             '<div type="button" class="btn btn-danger btn-lg" width:65px; vertical-align=middle;">'+
                                                 '<img src="/image/ddoBtn4.png" onclick="openModal(marker, places)" style="width:65px; margin: 7px 0px 0px 5px;"/>'+
                                             '</div>'+
                                     '</div>'+
                                 '</div>'+
                             '</div>'
    ...
    function openModal(marker, places) {
        if (marker && places) {
            ...
            var placeAddress = places.road_address_name;
